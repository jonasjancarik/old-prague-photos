        ...
        <details class="workflow-help">
          ...
          <div class="workflow-help-body">
            <div class="workflow-help-item">
              <strong>Sedí</strong>
              <span>Potvrzuje polohu celé série na mapě.</span>
            </div>
            <div class="workflow-help-item">
              <strong>Nesedí</strong>
              <span>Opravte bod v mapě, nebo označte, že přesné místo nevíte.</span>
            </div>
            <div class="workflow-help-item">
              <strong>Další fotka</strong>
              <span>Přeskočí nejistý případ bez uložení hlasu.</span>
            </div>
          </div>
        </details>
